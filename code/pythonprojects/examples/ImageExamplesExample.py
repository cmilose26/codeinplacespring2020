...
from pythonprojects.utilities.simpleimage import SimpleImage
...
def main():
    ...
    """
    original_flower = SimpleImage('utilities/images/flower.png')
    original_flower.show()

    dark_flower = darker('utilities/images/flower.png')
    dark_flower.show()

    red_flower = red_channel('utilities/images/flower.png')
    red_flower.show()

    grayscale_flower_avg = grayscale('utilities/images/flower.png')
    grayscale_flower_avg.show()
    
    right_half_darker_flower = right_half_darker('utilities/images/flower.png')
