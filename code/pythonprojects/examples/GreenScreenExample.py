...
def main():
    ...
    """
    original_stop = SimpleImage('99-Images/stop.png')
    original_stop.show()

    original_leaves = SimpleImage('99-Images/leaves.png')
    original_leaves.show()

    stop_leaves_replaced = redscreen('99-Images/stop.png', '99-Images/leaves.png')
